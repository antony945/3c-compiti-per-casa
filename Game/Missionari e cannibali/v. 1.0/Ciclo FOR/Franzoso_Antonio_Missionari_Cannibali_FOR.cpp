...
void inizializza(void){ //FATTO
    gioco_terminato = false;
    vittoria = false, sconfitta = false;
...
void disegnaConfigurazione(void){ //FATTO
	system("CLS");
	cout << "---------------------------| MISSIONARI e CANNIBALI |--------------------------- \n\n";
...
void interazioneUtente(void){ //FATTO
...
void muoviMissionario(void){ //FATTO
...
void muoviCannibale(void){ //FATTO
    if (scelta_azione == 'U'){ //SALI SULLA BARCA
        if (lato_barca == 'd'){ //LATO BARCA = DESTRA
            if (cannibali_dx != 0){
                if ((missionari_barca+cannibali_barca) < 2){
...
void controllaFine(void){ //FATTO
    vittoria = ((missionari_sx+cannibali_sx) == 6);
    if (lato_barca == 'd'){ //LATO BARCA DESTRA
        if (missionari_dx == 0) //MISSIONARI DX = 0
            sconfitta = (missionari_sx < cannibali_sx);
        else{ //MISSIONARI DX != 0
            if (missionari_sx == 0) //MISSIONARI SX = 0
               sconfitta = ((missionari_dx+missionari_barca) < (cannibali_dx+cannibali_barca));
            else //MISSIONARI SX != 0
                sconfitta = (((missionari_dx+missionari_barca) < (cannibali_dx+cannibali_barca)) || (missionari_sx < cannibali_sx));
        }
    }else{ //LATO BARCA SINISTRA
        if (missionari_sx == 0) //MISSIONARI SX = 0
            sconfitta = (missionari_dx < cannibali_dx);
        else{ //MISSIONARI SX != 0
            if (missionari_dx == 0) //MISSIONARI DX = 0
                sconfitta = ((missionari_sx+missionari_barca) < (cannibali_sx+cannibali_barca));
            else //MISSIONARI DX != 0
                sconfitta = ((missionari_dx < cannibali_dx) || ((missionari_sx+missionari_barca) < (cannibali_sx+cannibali_barca)));
        }
    }
    gioco_terminato = (vittoria || sconfitta);
}

void messaggioFinale(void){ //FATTO
    if (vittoria)
